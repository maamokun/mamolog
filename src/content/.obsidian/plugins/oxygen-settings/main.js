    ...
    return {
      light: [
        ...
        ((_b = preset.light.colors) == null ? void 0 : _b.tx1) ||
          hslToHex({ ...preset.light.base, l: Math.max(0, preset.light.base.l - 30) }),
      ],
      dark: [
        ...
        ((_d = preset.dark.colors) == null ? void 0 : _d.tx1) ||
          hslToHex({ ...preset.dark.base, l: Math.min(100, preset.dark.base.l + 30) }),
      ],
    };
  }
};
...
var MinimalSettingsTab = class extends import_obsidian10.PluginSettingTab {
            ...
            render: (setting) => {
              setting.addDropdown((dropdown) => {
                dropdown
                  ...
                  .addOption("oxygen-things-light", "Things");
                if (
                  this.plugin.settings.enableCustomPresets &&
                  this.plugin.settings.customPresets.length > 0
                ) {
                  this.plugin.settings.customPresets
                    .sort((a, b) => a.name.localeCompare(b.name))
                    .forEach((preset) => {
  ...
  addPresetListItem(container, preset, refreshCallback) {
    ...
    details.createEl("div", { text: preset.id, cls: "preset-id preset-id-display" });
    new import_obsidian10.Setting(presetItem)
      .setName("")
      .setDesc("")
      .addExtraButton((button) =>
        button
  ...
  async deletePreset(preset, refreshCallback) {
    ...
    this.plugin.settings.customPresets = this.plugin.settings.customPresets.filter(
      (p) => p.id !== preset.id,
    );
...
var MinimalTheme = class extends import_obsidian12.Plugin {
  ...
  async onload() {
    ...
    const initialThemeMode = activeDocument.body.classList.contains("theme-light")
      ? "light"
      : "dark";
    ...
    this.registerEvent(
      this.app.workspace.on("css-change", () => {
        ...
        debounceTimer = window.setTimeout(() => {
          ...
          const currentThemeMode = activeDocument.body.classList.contains("theme-light")
            ? "light"
            : "dark";

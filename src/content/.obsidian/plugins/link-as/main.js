...
var LinkAsSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.showPathInPicker).onChange(async (value) => {
...
var LinkAsPlugin = class extends import_obsidian3.Plugin {
  ...
  getNoteTitle(file) {
    ...
    if (propertyKey) {
      const value =
        (_b = (_a = this.app.metadataCache.getFileCache(file)) == null ? void 0 : _a.frontmatter) ==
        null
          ? void 0
          : _b[propertyKey];
  ...
  getPofnPropertyKey() {
    ...
    const pofn =
      (_b = (_a = this.app.plugins) == null ? void 0 : _a.plugins) == null
        ...
        : _b[POFN_PLUGIN_ID];
    const key =
      (_d = (_c = pofn == null ? void 0 : pofn.settings) == null ? void 0 : _c.propertyKey) == null
        ? void 0
        : _d.trim();
    return key || null;
  }

...
var _UIManager = class _UIManager {
  ...
  markSingleTabContainers() {
    const containers = this.doc.querySelectorAll(".workspace-tabs:not(.mod-stacked)");
    containers.forEach((container) => {
      const headerCount = container.querySelectorAll(
        ":scope > .workspace-tab-header-container > .workspace-tab-header",
      ).length;
      const fallbackHeaderCount =
        headerCount > 0 ? headerCount : container.querySelectorAll(".workspace-tab-header").length;
...
_UIManager.ICON_BUTTON_HIDES = [
  {
    settingKey: "newNoteButton",
    containerSelector: ".clickable-icon.nav-action-button",
    icons: ["lucide-edit"],
  },
  {
    settingKey: "newFolderButton",
    containerSelector: ".clickable-icon.nav-action-button",
    icons: ["lucide-folder-plus"],
  },
  {
    settingKey: "sortOrderButton",
    containerSelector: ".clickable-icon.nav-action-button",
    icons: ["lucide-sort-asc"],
  },
  {
    settingKey: "autoRevealButton",
    containerSelector: ".clickable-icon.nav-action-button",
    icons: ["lucide-gallery-vertical"],
  },
  {
    settingKey: "collapseAllButton",
    containerSelector: ".clickable-icon.nav-action-button",
    icons: ["lucide-chevrons-up-down", "lucide-chevrons-down-up"],
  },
  {
    settingKey: "readingModeButton",
    containerSelector: ".view-header .clickable-icon.view-action",
    icons: ["lucide-book-open", "lucide-edit-3"],
  },
  {
    settingKey: "bookmarkedButton",
    containerSelector: ".view-header .clickable-icon.view-action",
    icons: ["lucide-bookmark"],
  },
  {
    settingKey: "searchSettingsButton",
    containerSelector: ".search-row .clickable-icon",
    icons: ["lucide-sliders-horizontal"],
  },
  {
    settingKey: "mobileChevronsIcon",
    containerSelector: ".mobile-navbar .navbar-action-flair",
    icons: ["lucide-chevrons-up-down"],
  },
];
...
var getIconList = () => {
  if (
    import_obsidian3.requireApiVersion &&
    (0, import_obsidian3.requireApiVersion)("1.7.3") &&
    import_obsidian3.getIconIds
  ) {
    try {
...
var TabRenderer = class {
  ...
  createDropdownSetting(container, name, description, value, options, onChange) {
    return new import_obsidian4.Setting(container)
      .setName(name)
      .setDesc(description)
  ...
  reorderAndRerender(items, fromIndex, toIndex, container) {
    void (async () => {
      ...
      const scrollContainer =
        (_d =
          (_c =
            (_b = container.closest(".vertical-tab-content")) != null
              ? _b
              : container.closest(".settings-content")) != null
            ? _c
            : container.closest(".vertical-tab-content-container")) != null
          ? _d
          : container;
      const scrollPos = scrollContainer.scrollTop;
...
var PropertiesTab = class extends TabRenderer {
  ...
  renderPropertyIconsSection(container, includeHeading = true) {
    ...
    const propGroup = includeHeading
      ? new import_obsidian11.SettingGroup(container).setHeading("Property Icons")
      : new import_obsidian11.SettingGroup(container);
...
var _UITweakerSettingTab = class _UITweakerSettingTab extends import_obsidian12.PluginSettingTab {
            ...
            items: [
              ...
              },
              {
                ...
                visible: () => {
                  var _a;
                  return Boolean(
                    (_a = this.plugin.settings.helpButtonReplacement) == null ? void 0 : _a.enabled,
                  );
                },
                render: (setting) => {
              ...
              },
              {
                ...
                control: {
                  type: "slider",
                  key: "vaultSwitcherBackgroundTransparency",
                  min: 0,
                  max: 1,
                  step: 0.01,
                },
        ...
        items: [
          {
            ...
            render: (setting) => {
              this.hidePropertiesSettingChrome(setting);
              const host = setting.settingEl.createDiv();
              this.explorerPageTab().renderResetButtonSeparate(
                host,
                [
                  "newNoteButton",
                  "newFolderButton",
            ...
            items: [
              {
                ...
                render: (setting) => {
                  ...
                  this.propertiesPageTab().renderPropertyIconsSection(
                    this.propertiesIconsSectionHost,
                    false,
                  );
                },
              },
            ...
            items: [
              ...
              },
              {
                ...
                visible: () => {
                  var _a;
                  return Boolean(
                    (_a = this.plugin.settings.syncButtonReplacement) == null ? void 0 : _a.enabled,
                  );
                },
                render: (setting) => {
            ...
            items: [
              {
                ...
                control: {
                  type: "dropdown",
                  key: "navigateButtonPosition",
                  options: this.mobilePositionOptions(),
                },
              },
              {
  ...
  renderHelpButtonIconControl(setting) {
    ...
    setting.addButton((button) =>
      button
        .setButtonText(this.syncButtonIconName(replacement.iconId) || "Select icon...")
        .onClick(() => {
          const modal = new IconPickerModal(this.app, (iconId) => {
            void (async () => {
...
var StatusBarManager = class {
  ...
  generateCanonicalName(element, allClasses) {
    ...
    if (
      ...
      if (allClasses.some((c) => c.includes("sync") || c.includes("status")))
        return "plugin-obsidian-git-status";
      if (text.includes("branch") || text.includes("master") || text.includes("main"))
    ...
    const pluginClass = allClasses.find((cls) => cls.includes("plugin-"));
    if (pluginClass) {
...
var ButtonReplacer = class {
  ...
  get doc() {
    var _a, _b, _c;
    return (_c = (_b = (_a = this.options).getDoc) == null ? void 0 : _b.call(_a)) != null
      ? _c
      : activeDocument;
  }
  install() {
  ...
  tryInstall() {
    ...
    if (
      ...
      this.doc.body.contains(this.customButton)
    ) {
      return;
    }

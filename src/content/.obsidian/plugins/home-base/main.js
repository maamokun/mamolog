...
var require_main = __commonJS({
  "node_modules/.pnpm/obsidian-daily-notes-interf_8d9fc24b0fc622d94fd11fa5e9b185b3/node_modules/obsidian-daily-notes-interface/dist/main.js"(
    ...
    function shouldUsePeriodicNotesSettings(periodicity) {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a[periodicity]) == null
          ? void 0
          : _b.enabled)
      );
    }
      ...
      try {
        ...
        if (shouldUsePeriodicNotesSettings("daily")) {
          const {
            ...
            folder: folder2,
            template: template2,
          } = ((_b = (_a = plugins.getPlugin("periodic-notes")) == null ? void 0 : _a.settings) ==
          null
            ? void 0
            : _b.daily) || {};
          return {
        ...
        const { folder, format, template } =
          ((_d =
            (_c = internalPlugins.getPluginById("daily-notes")) == null ? void 0 : _c.instance) ==
          null
            ? void 0
            : _d.options) || {};
        return {
    ...
    function getWeeklyNoteSettings() {
      ...
      try {
        ...
        const calendarSettings =
          (_a = pluginManager.getPlugin("calendar")) == null ? void 0 : _a.options;
        const periodicNotesSettings =
          (_c = (_b = pluginManager.getPlugin("periodic-notes")) == null ? void 0 : _b.settings) ==
          null
            ? void 0
            : _c.weekly;
      ...
      try {
        const settings =
          (shouldUsePeriodicNotesSettings("monthly") &&
            ((_b =
              (_a = pluginManager.getPlugin("periodic-notes")) == null ? void 0 : _a.settings) ==
            null
              ? void 0
              : _b.monthly)) ||
          {};
    ...
    function isFormatAmbiguous(format, granularity) {
      if (granularity === "week") {
        ...
        return (
          /w{1,2}/i.test(cleanFormat) && (/M{1,4}/.test(cleanFormat) || /D{1,4}/.test(cleanFormat))
        );
      }
      return false;
    }
    ...
    function appHasDailyNotesPluginLoaded() {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a.daily) == null
          ? void 0
          : _b.enabled)
      );
    }
    function appHasWeeklyNotesPluginLoaded() {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a.weekly) == null
          ? void 0
          : _b.enabled)
      );
    }
    function appHasMonthlyNotesPluginLoaded() {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a.monthly) == null
          ? void 0
          : _b.enabled)
      );
    }
    function appHasQuarterlyNotesPluginLoaded() {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a.quarterly) == null
          ? void 0
          : _b.enabled)
      );
    }
    function appHasYearlyNotesPluginLoaded() {
      ...
      return (
        periodicNotes &&
        ((_b = (_a = periodicNotes.settings) == null ? void 0 : _a.yearly) == null
          ? void 0
          : _b.enabled)
      );
    }
...
var WorkspaceSuggest = class extends import_obsidian.AbstractInputSuggest {
  ...
  getSuggestions(query) {
    ...
    const lowerQuery = query.toLowerCase();
    return workspaces.filter((workspace) => workspace.toLowerCase().includes(lowerQuery));
  }
...
function executeCommand(app, commandId) {
  ...
  const appWithCommands = app;
  const result =
    (_b = (_a = appWithCommands.commands) == null ? void 0 : _a.executeCommandById) == null
      ? void 0
          ...
          },
          {
            ...
            desc:
              activeType === "File" /* File */
                ...
                : activeType === "Workspace" /* Workspace */
                  ? "The workspace to load as your home base"
                  : activeType === "Random in folder" /* RandomFolder */
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            visible: () =>
              this.plugin.settings.replaceNewTab && this.plugin.settings.useDifferentFileForNewTab,
            // Render: dynamic options, disabled entries, and a missing-plugin warning.
            render: (setting) => {
              renderTypeDropdown(
                setting,
          ...
          },
          {
            name: (() => {
              ...
              return t === "File" /* File */
                ...
                : t === "Workspace" /* Workspace */
                  ? "New tab workspace"
                  : t === "Random in folder" /* RandomFolder */
                    ? "New tab folder"
                    : t === "Journal" /* Journal */
                      ? "New tab journal"
                      : "New tab value";
            ...
            desc: (() => {
              ...
              return t === "File" /* File */
                ...
                : t === "Workspace" /* Workspace */
                  ? "The workspace to load for new tabs"
                  : t === "Random in folder" /* RandomFolder */
                    ? "The folder to pick a random file from for new tabs"
                    : t === "Journal" /* Journal */
                      ? "The journal name for new tabs"
                      : "";
            })(),
            visible: () =>
              this.plugin.settings.replaceNewTab &&
              this.plugin.settings.useDifferentFileForNewTab &&
              !UNCHANGEABLE_TYPES.includes(this.plugin.settings.newTabType || "File" /* File */),
            // Render: attaches a type-specific suggester to the text input.
            render: (setting) => {
              const t = this.plugin.settings.newTabType || "File" /* File */;
              const placeholder =
                t === "File" /* File */
                  ? "Path to new tab file"
                  : t === "Workspace" /* Workspace */
                    ? "Workspace name"
                    : t === "Random in folder" /* RandomFolder */
                      ? "Folder path"
        ...
        items: [
          ...
          },
          {
            ...
            desc: (() => {
              const t = this.plugin.settings.mobileHomeBaseType;
              return t === "File" /* File */
                ? "The file to open as your home base on mobile"
                : t === "Workspace" /* Workspace */
                  ? "The workspace to load as your home base on mobile"
                  : t === "Random in folder" /* RandomFolder */
                    ? "The folder to pick a random file from on mobile"
                    : t === "Journal" /* Journal */
                      ? "The journal name for mobile"
                      : "";
            })(),
            visible: () =>
          ...
          },
          {
            ...
            desc: (() => {
              const t = this.plugin.settings.mobileNewTabType || "File" /* File */;
              return t === "File" /* File */
                ? "The file to open for new tabs on mobile"
                : t === "Workspace" /* Workspace */
                  ? "The workspace to load for new tabs on mobile"
                  : t === "Random in folder" /* RandomFolder */
                    ? "The folder to pick a random file from for new tabs on mobile"
                    : t === "Journal" /* Journal */
                      ? "The journal name for new tabs on mobile"
                      : "";
            })(),
            visible: () =>
              this.plugin.settings.useDifferentFileForNewTab &&
              this.plugin.settings.newTabSeparateMobile &&
              !UNCHANGEABLE_TYPES.includes(
                this.plugin.settings.mobileNewTabType || "File" /* File */,
              ),
            // Render: attaches a type-specific suggester to the text input.
            render: (setting) => {
        ...
        setting
          ...
          .addText((text) => {
            ...
            text
              .setPlaceholder("3")
              .setValue(
                ((_a = this.plugin.settings.gitSyncTimeout) == null ? void 0 : _a.toString()) ||
                  "3",
              )
              .onChange(async (value) => {
...
function leafHasFile(leaf, filePath) {
  var _a, _b;
  const state =
    (_b = (_a = leaf.view) == null ? void 0 : _a.getState) == null ? void 0 : _b.call(_a);
...
async function getPeriodicNote(kind, plugin) {
  ...
  const isLegacy =
    !periodicNotesPlugin ||
    (((_b = periodicNotesPlugin.manifest) == null ? void 0 : _b.version) || "0").startsWith("0");
  let note = null;
  if (isLegacy) {
    let all = info.getAll();
    ...
    (_d = (_c = periodicNotesPlugin.cache) == null ? void 0 : _c.initialize) == null
      ? void 0
      : _d.call(_c);
    note =
      (_f =
    ...
    if (!note && plugin.settings.waitForGitSync) {
      ...
      await delay(plugin.settings.gitSyncTimeout * 1e3);
      (_h = (_g = periodicNotesPlugin.cache) == null ? void 0 : _g.initialize) == null
        ? void 0
        : _h.call(_g);
      note =
        (_j =
...
async function getJournalNote(journalName, plugin) {
  ...
  try {
    ...
    const origAutoCreate =
      (_d = (_c = journal.config) == null ? void 0 : _c.value) == null ? void 0 : _d.autoCreate;
...
function resolvePathSync(type, value, app) {
  switch (type) {
    ...
    default:
      return type === "Random in folder" /* RandomFolder */ || type === "New note" /* NewNote */
        ? null
        : value || null;
  }
}
...
var HomeBaseService = class {
  ...
  async openHomeBaseWithMode(mode, runCommand = true) {
    ...
    if (mode === "replace-all") {
      ...
      const activeLeaf =
        (_a = this.app.workspace.getActiveViewOfType(import_obsidian7.View)) == null
          ? void 0
          : _a.leaf;
      if (activeLeaf) {
    ...
    const newLeaf =
      mode === "retain" ? this.app.workspace.getLeaf("tab") : this.app.workspace.getLeaf(false);
    if (!newLeaf) {
      return false;
    }
  ...
  async openGraph() {
    var _a, _b;
    await ((_b = (_a = this.app.commands) == null ? void 0 : _a.executeCommandById) == null
      ? void 0
  ...
  async openInLeafWithSettings(leaf, settings, isNewTab = false) {
    ...
    const resolvedPath = await computeHomeBasePath(settings.type, settings.value, this.plugin);
    if (!resolvedPath) {
      console.warn(
  ...
  async revertView() {
    ...
    const source =
      (config == null ? void 0 : config.livePreview) !== void 0 ? !config.livePreview : false;
    if (
  ...
  findExistingHomeBaseLeaf(file) {
    ...
    const leaves = LEAF_TYPES.flatMap((type) => this.app.workspace.getLeavesOfType(type));
  ...
  async openHomeBaseInGhostTab(options = {}) {
    ...
    if (homeBaseSettings.type === "Graph view" /* Graph */) {
      ...
      await new Promise((resolve) =>
        activeWindow.setTimeout(resolve, GRAPH_COMMAND_FALLBACK_DELAY),
      );
  ...
  async detachAllLeaves() {
    ...
    if (import_obsidian7.Platform.isMobile) {
      (_b = (_a = this.app.workspace.rightSplit) == null ? void 0 : _a.updateInfo) == null
        ? void 0
        : _b.call(_a);
    }
  }
  ...
  isSettingsModalOpen() {
    const settingsModal =
      window.document.querySelector(".modal-container.mod-settings") ||
...
var NewTabService = class {
  ...
  isSettingsModalOpen() {
    const settingsModal =
      activeDocument.querySelector(".modal-container.mod-settings") ||
              ...
              if (this.plugin.homeService.isGhostLeaf(leaf)) {
                ...
                if (tabHeader && tabHeader.parentElement) {
                  ...
                  if (parent && parent.classList.contains("workspace-tab-header-container-inner")) {
                    const mainWorkspaceDoc = document.querySelector(
                      ".workspace-split.mod-vertical.mod-root",
                    );
                    const primaryTabContainer = mainWorkspaceDoc
                      ? mainWorkspaceDoc.querySelector(".workspace-tab-header-container-inner")
                      : null;
        ...
        if (container) {
          ...
          if (rootWorkspace && !leftSidebar && !rightSidebar) {
            ...
            const primaryTabContainer = mainWorkspaceDoc
              ? mainWorkspaceDoc.querySelector(".workspace-tab-header-container-inner")
              : null;
            const currentOrPreviousParent =
              tabHeader.parentElement || tabHeaderExtended._homeBaseParent;
            ...
            if (!isGhostInPrimary) {
              ...
              const isGraphHome =
                ...
                ((_a = leaf.view) == null ? void 0 : _a.getViewType()) === "graph";
...
var HomeBasePlugin = class extends import_obsidian11.Plugin {
      ...
      this.titleObserver = new MutationObserver(() => {
        ...
        if (activeLeaf && this.homeService.isGhostLeaf(activeLeaf)) {
          ...
          if (title.startsWith("New tab") || title.startsWith("Empty")) {
            const viewTitle =
              ((_a = activeLeaf.view) == null ? void 0 : _a.getDisplayText()) || "Home";
  ...
  hasRequiredPlugin(type) {
    ...
    switch (type) {
      ...
      case "Graph view" /* Graph */:
        return (
          ((_f =
            (_e = (_d = this.app.internalPlugins) == null ? void 0 : _d.plugins) == null
              ? void 0
              : _e.graph) == null
            ? void 0
            : _f.enabled) === true
      ...
      case "Journal" /* Journal */:
        return !!((_h = (_g = this.app.plugins) == null ? void 0 : _g.plugins) == null
          ? void 0
          : _h["journals"]);
      case "Daily Note" /* DailyNote */:
      case "Weekly Note" /* WeeklyNote */:
  ...
  hasRequiredPeriodicity(type) {
    ...
    if (type === "Daily Note" /* DailyNote */) {
      ...
      if (periodicNotes2) {
        const version2 =
          ((_f = periodicNotes2 == null ? void 0 : periodicNotes2.manifest) == null
            ? void 0
            : _f.version) || "0";
        ...
        if (isLegacy2) {
          return (
            ((_h =
              (_g = periodicNotes2 == null ? void 0 : periodicNotes2.settings) == null
                ? void 0
                : _g["daily"]) == null
              ? void 0
              : _h.enabled) === true
          ...
          const calendarSet =
            (_j =
              (_i = periodicNotes2 == null ? void 0 : periodicNotes2.calendarSetManager) == null
                ? void 0
    ...
    if (isLegacy) {
      ...
      const calendarSet =
        (_r =
          (_q = periodicNotes == null ? void 0 : periodicNotes.calendarSetManager) == null
            ? void 0
            : _q.getActiveSet) == null
          ? void 0
          : _r.call(_q);
      return (
        ((_s = calendarSet == null ? void 0 : calendarSet[noun]) == null ? void 0 : _s.enabled) ===
        true
      );
    }
  }

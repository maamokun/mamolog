  ...
  Ze = (s, e, t, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of on(e))
        !an.call(s, i) &&
          i !== t &&
          pe(s, i, { get: () => e[i], enumerable: !(n = sn(e, i)) || n.enumerable });
    return s;
  };
var un = (s, e, t) => (
    (t = s != null ? nn(rn(s)) : {}),
  ...
  cn = (s) => Ze(pe({}, "__esModule", { value: !0 }), s);
var $e = x((ms, et) => {
  "use strict";
  var gn =
...
var xe = x((hs, tt) => {
  ...
  var dn = "2.0.0",
    ...
    mn = 16,
    hn = 250,
    fn = ["major", "premajor", "minor", "preminor", "patch", "prepatch", "prerelease"];
  tt.exports = {
    MAX_LENGTH: 256,
    MAX_SAFE_COMPONENT_LENGTH: mn,
    MAX_SAFE_BUILD_LENGTH: hn,
    MAX_SAFE_INTEGER: pn,
    RELEASE_TYPES: fn,
    SEMVER_SPEC_VERSION: dn,
...
var Be = x((F, nt) => {
  "use strict";
  var { MAX_SAFE_COMPONENT_LENGTH: Oe, MAX_SAFE_BUILD_LENGTH: bn, MAX_LENGTH: wn } = xe(),
    Tn = $e();
  F = nt.exports = {};
  var En = (F.re = []),
    yn = (F.safeRe = []),
    ...
    y = (s, e, t) => {
      ...
      (Tn(s, i, e),
        ...
        (h[i] = e),
        (vn[i] = n),
        (En[i] = new RegExp(e, t ? "g" : void 0)),
        (yn[i] = new RegExp(n, t ? "g" : void 0)));
    };
  y("NUMERICIDENTIFIER", "0|[1-9]\\d*");
  y("NUMERICIDENTIFIERLOOSE", "\\d+");
  y("NONNUMERICIDENTIFIER", `\\d*[a-zA-Z-]${Fe}*`);
  y(
    "MAINVERSION",
    `(${h[f.NUMERICIDENTIFIER]})\\.(${h[f.NUMERICIDENTIFIER]})\\.(${h[f.NUMERICIDENTIFIER]})`,
  );
  y(
    "MAINVERSIONLOOSE",
  ...
  y("XRANGEIDENTIFIER", `${h[f.NUMERICIDENTIFIER]}|x|X|\\*`);
  y(
    "XRANGEPLAIN",
    `[v=\\s]*(${h[f.XRANGEIDENTIFIER]})(?:\\.(${h[f.XRANGEIDENTIFIER]})(?:\\.(${h[f.XRANGEIDENTIFIER]})(?:${h[f.PRERELEASE]})?${h[f.BUILD]}?)?)?`,
  );
  y(
    "XRANGEPLAINLOOSE",
    `[v=\\s]*(${h[f.XRANGEIDENTIFIERLOOSE]})(?:\\.(${h[f.XRANGEIDENTIFIERLOOSE]})(?:\\.(${h[f.XRANGEIDENTIFIERLOOSE]})(?:${h[f.PRERELEASELOOSE]})?${h[f.BUILD]}?)?)?`,
  );
  ...
  y("LONETILDE", "(?:~>?)");
  y("TILDETRIM", `(\\s*)${h[f.LONETILDE]}\\s+`, !0);
  F.tildeTrimReplace = "$1~";
  y("TILDE", `^${h[f.LONETILDE]}${h[f.XRANGEPLAIN]}$`);
  y("TILDELOOSE", `^${h[f.LONETILDE]}${h[f.XRANGEPLAINLOOSE]}$`);
  y("LONECARET", "(?:\\^)");
  y("CARETTRIM", `(\\s*)${h[f.LONECARET]}\\s+`, !0);
  F.caretTrimReplace = "$1^";
  y("CARET", `^${h[f.LONECARET]}${h[f.XRANGEPLAIN]}$`);
...
var it = x((fs, st) => {
  "use strict";
  var Nn = Object.freeze({ loose: !0 }),
    An = Object.freeze({}),
    Cn = (s) => (s ? (typeof s != "object" ? Nn : s) : An);
  st.exports = Cn;
});
var lt = x((bs, at) => {
  "use strict";
  var ot = /^[0-9]+$/,
    ...
    Ln = (s, e) => rt(e, s);
  at.exports = { compareIdentifiers: rt, rcompareIdentifiers: Ln };
});
var we = x((ws, ct) => {
  "use strict";
  var me = $e(),
    { MAX_LENGTH: ut, MAX_SAFE_INTEGER: he } = xe(),
    { safeRe: fe, t: be } = Be(),
    kn = it(),
    { compareIdentifiers: Me } = lt(),
    Ve = class s {
      constructor(e, t) {
        if (((t = kn(t)), e instanceof s)) {
        ...
        let n = e.trim().match(t.loose ? fe[be.LOOSE] : fe[be.FULL]);
...
var Ue = x((Ts, dt) => {
  "use strict";
  var gt = we(),
    Sn = (s, e, t) => new gt(s, t).compare(new gt(e, t));
  dt.exports = Sn;
});
var ht = x((Es, mt) => {
  "use strict";
    ...
    On = (s, e) => {
      ...
      if (!e.rtl) t = s.match(e.includePrerelease ? Te[Ee.COERCEFULL] : Te[Ee.COERCE]);
        ...
        let u = e.includePrerelease ? Te[Ee.COERCERTLFULL] : Te[Ee.COERCERTL],
          g;
        for (; (g = u.exec(s)) && (!t || t.index + t[0].length !== s.length); )
          ((!t || g.index + g[0].length !== t.index + t[0].length) && (t = g),
            (u.lastIndex = g.index + g[1].length + g[2].length));
        u.lastIndex = -1;
      }
      ...
      let n = t[2],
        i = t[3] || "0",
        o = t[4] || "0",
        a = e.includePrerelease && t[5] ? `-${t[5]}` : "",
        c = e.includePrerelease && t[6] ? `+${t[6]}` : "";
      return xn(`${n}.${i}.${o}${a}${c}`, e);
    };
  ft.exports = On;
});
var Qt = x((v) => {
  ...
  function ae() {
    ...
    try {
      ...
      if (re("daily")) {
        ...
        return {
          format: g || qe,
          folder: (m == null ? void 0 : m.trim()) || "",
          template: (l == null ? void 0 : l.trim()) || "",
        };
      }
      let {
        folder: a,
  ...
  function le() {
    ...
    try {
      ...
      if (re("weekly"))
        return {
          format: g.format || Ye,
          folder: ((n = g.folder) == null ? void 0 : n.trim()) || "",
          template: ((i = g.template) == null ? void 0 : i.trim()) || "",
        };
      let m = u || {};
      return {
  ...
  function ue() {
    ...
    try {
      ...
      return {
        format: o.format || Vt,
        folder: ((n = o.folder) == null ? void 0 : n.trim()) || "",
  ...
  function Ht(...s) {
    let e = [];
    for (let n = 0, i = s.length; n < i; n++) e = e.concat(s[n].split("/"));
    let t = [];
  ...
  function $(s, e = "day") {
    let t = s.clone().startOf(e).format();
    return `${e}-${t}`;
  }
  function Gt(s) {
    return s.replace(/\[[^\]]*\]/g, "");
  ...
  function X(s, e) {
    return jt(s.basename, e);
  }
  function qn(s, e) {
    return jt(Gn(s), e);
  }
  function jt(s, e) {
    let n = { day: ae, week: le, month: ue, quarter: ce, year: ge }[e]().format.split("/").pop(),
  ...
  async function zt(s) {
    let e = window.app,
      { vault: t } = e,
      n = window.moment,
      { template: i, format: o, folder: a } = ae(),
      [c, u] = await Y(i),
      g = s.format(o),
      m = await de(a, g);
    try {
      let l = await t.create(
        m,
        c
          .replace(/{{\s*date\s*}}/gi, g)
          .replace(/{{\s*time\s*}}/gi, n().format("HH:mm"))
          .replace(/{{\s*title\s*}}/gi, g)
          .replace(
      ...
      (console.error(`Failed to create file: '${m}'`, l),
        new I.Notice("Unable to create new file."));
    }
  }
  function Yn(s, e) {
    var t;
    return (t = e[$(s, "day")]) != null ? t : null;
  }
  function Xn() {
    let { vault: s } = window.app,
      { folder: e } = ae(),
      t = s.getAbstractFileByPath(I.normalizePath(e));
    if (!t) throw new Xe("Failed to find daily notes folder");
    let n = {};
    return (
  ...
  function Jn(s) {
    return Wn().indexOf(s.toLowerCase());
  }
  async function qt(s) {
    let { vault: e } = window.app,
      { template: t, format: n, folder: i } = le(),
      [o, a] = await Y(t),
      c = s.format(n),
      u = await de(i, c);
    try {
      let g = await e.create(
        u,
        o
          .replace(
            /{{\s*(date|time)\s*(([+-]\d+)([yqmwdhs]))?\s*(:.+?)?}}/gi,
            (m, l, r, d, b, w) => {
              let p = window.moment(),
                T = s
                  .clone()
                  .set({ hour: p.get("hour"), minute: p.get("minute"), second: p.get("second") });
              return (
          ...
          .replace(
            ...
            (m, l, r) => {
              let d = Jn(l);
              return s.weekday(d).format(r.trim());
            },
          ),
      );
      return (window.app.foldManager.save(g, a), g);
    } catch (g) {
      (console.error(`Failed to create file: '${u}'`, g),
        new I.Notice("Unable to create new file."));
    }
  }
  function Kn(s, e) {
    var t;
    return (t = e[$(s, "week")]) != null ? t : null;
  }
  function Qn() {
    let s = {};
    if (!Xt()) return s;
    let { vault: e } = window.app,
      { folder: t } = le(),
      n = e.getAbstractFileByPath(I.normalizePath(t));
    if (!n) throw new We("Failed to find weekly notes folder");
    return (
      I.Vault.recurseChildren(n, (i) => {
        if (i instanceof I.TFile) {
          let o = X(i, "week");
          if (o) {
            let a = $(o, "week");
  ...
  async function Yt(s) {
    let { vault: e } = window.app,
      { template: t, format: n, folder: i } = ue(),
      [o, a] = await Y(t),
      c = s.format(n),
      u = await de(i, c);
    try {
  ...
  function Zn(s, e) {
    var t;
    return (t = e[$(s, "month")]) != null ? t : null;
  }
  function es() {
    let s = {};
    if (!Wt()) return s;
    let { vault: e } = window.app,
      { folder: t } = ue(),
      n = e.getAbstractFileByPath(I.normalizePath(t));
    if (!n) throw new Je("Failed to find monthly notes folder");
    return (
      I.Vault.recurseChildren(n, (i) => {
        if (i instanceof I.TFile) {
          let o = X(i, "month");
  ...
  async function ts(s) {
    let { vault: e } = window.app,
      { template: t, format: n, folder: i } = ce(),
      [o, a] = await Y(t),
      c = s.format(n),
      u = await de(i, c);
    try {
  ...
  function ns(s, e) {
    var t;
    return (t = e[$(s, "quarter")]) != null ? t : null;
  }
  function ss() {
    let s = {};
    if (!Jt()) return s;
    let { vault: e } = window.app,
      { folder: t } = ce(),
      n = e.getAbstractFileByPath(I.normalizePath(t));
    if (!n) throw new Ke("Failed to find quarterly notes folder");
    return (
      I.Vault.recurseChildren(n, (i) => {
        if (i instanceof I.TFile) {
          let o = X(i, "quarter");
  ...
  async function is(s) {
    let { vault: e } = window.app,
      { template: t, format: n, folder: i } = ge(),
      [o, a] = await Y(t),
      c = s.format(n),
      u = await de(i, c);
    try {
  ...
  function rs() {
    ...
    let { vault: e } = window.app,
      { folder: t } = ge(),
      n = e.getAbstractFileByPath(I.normalizePath(t));
    if (!n) throw new Qe("Failed to find yearly notes folder");
    return (
      I.Vault.recurseChildren(n, (i) => {
        if (i instanceof I.TFile) {
          let o = X(i, "year");
  ...
  function ls(s) {
    let e = { day: ae, week: le, month: ue, quarter: ce, year: ge }[s];
    return e();
  }
  function us(s, e) {
    return { day: zt, month: Yt, week: qt }[s](e);
  }
  v.DEFAULT_DAILY_NOTE_FORMAT = qe;
  v.DEFAULT_MONTHLY_NOTE_FORMAT = Vt;
  v.DEFAULT_QUARTERLY_NOTE_FORMAT = Ut;
  v.DEFAULT_WEEKLY_NOTE_FORMAT = Ye;
  v.DEFAULT_YEARLY_NOTE_FORMAT = _t;
  v.appHasDailyNotesPluginLoaded = as;
  v.appHasMonthlyNotesPluginLoaded = Wt;
  v.appHasQuarterlyNotesPluginLoaded = Jt;
  v.appHasWeeklyNotesPluginLoaded = Xt;
  v.appHasYearlyNotesPluginLoaded = Kt;
  v.createDailyNote = zt;
  v.createMonthlyNote = Yt;
  v.createPeriodicNote = us;
  v.createQuarterlyNote = ts;
  v.createWeeklyNote = qt;
  v.createYearlyNote = is;
  v.getAllDailyNotes = Xn;
  v.getAllMonthlyNotes = es;
  v.getAllQuarterlyNotes = ss;
  v.getAllWeeklyNotes = Qn;
  v.getAllYearlyNotes = rs;
  v.getDailyNote = Yn;
  v.getDailyNoteSettings = ae;
  v.getDateFromFile = X;
  v.getDateFromPath = qn;
  v.getDateUID = $;
  v.getMonthlyNote = Zn;
  v.getMonthlyNoteSettings = ue;
  v.getPeriodicNoteSettings = ls;
  v.getQuarterlyNote = ns;
  v.getQuarterlyNoteSettings = ce;
  v.getTemplateInfo = Y;
  v.getWeeklyNote = Kn;
  v.getWeeklyNoteSettings = le;
  v.getYearlyNote = os;
  v.getYearlyNoteSettings = ge;
});
var cs = {};
ln(cs, { default: () => ke });
module.exports = cn(cs);
var tn = require("obsidian");
var k = require("obsidian");
var K = require("obsidian"),
  Se = class extends K.Modal {
    constructor(t, n) {
      super(t.app);
      this.resolve = n;
      this.isConfirmed = !1;
    ...
    onOpen() {
      ...
      let t = new K.ButtonComponent(this.contentEl);
      ...
      let n = new K.ButtonComponent(this.contentEl);
...
var D = class extends Error {
    constructor(t, n, i, o) {
      let a = Math.ceil((i - Math.floor(Date.now() / 1e3)) / 60);
      super(`GitHub API rate limit exceeded. Reset in ${a} minutes.`);
      this.limit = t;
      this.remaining = n;
      this.reset = i;
      this.requestUrl = o;
...
var Fn = Ue(),
  bt = _e();
var ye = (s) => {
    let e = s.replace(/https?:\/\/github\.com\//i, "");
    return (
      e.endsWith("/") && (e = e.slice(0, -1)),
      e.toLowerCase().endsWith(".git") && (e = e.slice(0, -4)),
      e
    );
  },
  wt = ["ghp_", "github_pat_"],
  Bn = /^(gh[ps]_[a-zA-Z0-9]{36}|github_pat_[a-zA-Z0-9]{22}_[a-zA-Z0-9]{59})$/,
  Tt = (s) => Object.keys(s).reduce((e, t) => ((e[t.toLowerCase()] = s[t]), e), {}),
  Et = async (s, e) => {
    var o, a, c, u, g, m, l, r, d, b, w;
    let t = ["repo", "public_repo", "metadata=read"],
      n = wt.some((p) => s.toLowerCase().startsWith(p.toLowerCase())),
      i = Bn.test(s);
    if (!n || !i)
      return {
        validToken: !1,
        ...
        error: {
          type: n ? "invalid_format" : "invalid_prefix",
          message: "Invalid token format",
          details: { validPrefixes: wt },
        },
      };
    try {
      let p = Date.now() % 1e3,
        T = e || `user${p}/repo${p % 100}`;
      if (
        (await ve({
          url: `https://api.github.com/repos/${T}`,
          headers: { Authorization: `Token ${s}`, Accept: "application/vnd.github.v3+json" },
        }),
        e)
      )
        return {
      ...
      if (!(p instanceof O)) throw p;
      let T = Tt(p.headers);
      if (!T) throw new Error("No headers in GitHub response");
      let C = T["github-authentication-token-expiration"],
        N = C ? new Date(C) : null,
        R = N && !Number.isNaN(N.getTime()) ? N.toISOString() : null,
        P = {
          validToken: !1,
          currentScopes:
      ...
      return P.expirationDate && new Date(P.expirationDate) < new Date()
        ? ((P.error = {
            type: "expired",
            message: "Token has expired",
            details: { expirationDate: P.expirationDate },
          }),
          P)
        : P.currentScopes.some((M) => t.includes(M)) ||
            P.acceptedPermissions.some((M) => t.includes(M))
          ? ((P.validToken = p.status === 404), P)
          : ((P.error = {
              type: "insufficient_scope",
              message: "Token lacks required scopes. Check documentation for requirements.",
              details: { currentScopes: [...P.acceptedScopes, ...P.acceptedPermissions] },
            }),
            P);
    }
  },
  ...
  yt = async (s, e = !0, t = "") => {
    let n = `https://api.github.com/repos/${s}/releases`;
    try {
      return (
        await ve({ url: `${n}?per_page=100`, headers: t ? { Authorization: `Token ${t}` } : {} })
      ).json.map((a) => ({ version: a.tag_name, prerelease: a.prerelease }));
    } catch (i) {
      if (i instanceof D || i instanceof O) throw i;
      return (e && console.log("Error in fetchReleaseVersions", n, i), null);
    }
  },
  Q = async (s, e, t = !0, n = !1, i = "") => {
    try {
      let o = s.assets.find((g) => g.name === e);
      if (!o) return null;
      let a = { Accept: "application/octet-stream" };
      n && i && (a.Authorization = `Token ${i}`);
      let c = n ? o.url : o.browser_download_url,
        u = await (0, V.requestUrl)({ url: c, headers: a });
  ...
  vt = async (s = !0) => {
    ...
    try {
      let t = await (0, V.requestUrl)({ url: e });
      return t.status === 404 ? null : t.json;
    } catch (t) {
      return (s && console.log("error in grabCommmunityPluginList", t), null);
    }
  },
  Pt = async (s = !0) => {
    let e =
    ...
    try {
      ...
      return (s && console.log("error in grabCommmunityThemesList", t), null);
    }
  },
  G = async (s, e = !1, t = !1) => {
    let n = `https://raw.githubusercontent.com/${s}/HEAD/theme${e ? "-beta" : ""}.css`;
    try {
      let i = await (0, V.requestUrl)({ url: n });
  ...
  Rt = async (s, e = !0) => {
    let t = `https://raw.githubusercontent.com/${s}/HEAD/manifest.json`;
    try {
  ...
  Mn = (s) => {
    let e = 0;
    for (let t = 0; t < s.length; t++) e += s.charCodeAt(t);
    return e;
  },
  Z = (s) => Mn(s).toString(),
  ee = async (s, e, t) => {
  ...
  Vn = async (s, e, t = !0) => {
    let n = `https://api.github.com/repos/${s}/commits?path=${e}&page=1&per_page=1`;
    try {
      let i = await (0, V.requestUrl)({ url: n });
  ...
  It = async (s, e) => {
    var n;
    let t = await Vn(s, e);
    return t && t.length > 0 && (n = t[0].commit.committer) != null && n.date
      ? t[0].commit.committer.date
      : "";
  },
  Ge = async (s, e, t = !1, n = !1, i = !1, o) => {
    var a;
    try {
      let c =
          e && e !== "latest"
            ? `https://api.github.com/repos/${s}/releases/tags/${e}`
            : `https://api.github.com/repos/${s}/releases`,
        u = { Accept: "application/vnd.github.v3+json" };
      ((i && o) || o) && (u.Authorization = `Token ${o}`);
      let g = await ve({ url: c, headers: u });
      if (g.status === 404) return null;
      let m = e && e !== "latest" ? [g.json] : g.json;
      return (
        n && console.log(`grabReleaseFromRepository for ${s}:`, m),
        (a = m
          .sort((l, r) => {
            try {
              let d = bt(l.tag_name, { includePrerelease: !0, loose: !0 }),
                b = bt(r.tag_name, { includePrerelease: !0, loose: !0 });
              return Fn(b, d);
            } catch (d) {
              let b = new Date(l.published_at).getTime(),
                w = new Date(r.published_at).getTime();
              return b < w ? 1 : b > w ? -1 : 0;
            }
          })
          .filter((l) => t || !l.prerelease)[0]) != null
          ? a
          : null
      );
    } catch (c) {
  ...
  ve = async (s, e) => {
    let t = 0,
      n = 0,
      i = 0;
    s.headers = { ...s.headers, "User-Agent": "Obsidian/BRAT-Plugin" };
    try {
      return await (0, V.requestUrl)(s);
    } catch (o) {
      let a = new O(o),
        c = Tt(a.headers);
      if (
        (c &&
          ((t = Number.parseInt(c["x-ratelimit-limit"], 10)),
          (n = Number.parseInt(c["x-ratelimit-remaining"], 10)),
          (i = Number.parseInt(c["x-ratelimit-reset"], 10))),
        a.status === 403 && n === 0)
      ) {
        let u = new D(t, n, i, s.url);
        throw (
          e &&
            console.error(
              `BRAT
...
Reset in: ${u.getMinutesToReset()} minutes`,
      ...
      throw (e && console.log("GitHub request failed:", o), a);
    }
  };
var je = {
  pluginList: [],
...
function Nt(s, e, t = "latest", n = !1, i = "") {
  let o = !1;
  ...
  (a
    ? (Object.assign(a, {
        ...
        version: t,
        token: void 0,
        tokenName: i || a.tokenName,
        isIncompatible: n || void 0,
      }),
      (o = !0))
    : (s.settings.pluginSubListFrozenVersion.unshift({
        repo: e,
        version: t,
        token: void 0,
        tokenName: i || void 0,
...
function Pe(s, e) {
  return s.settings.pluginList.contains(e);
}
function At(s, e, t) {
  let n = { repo: e, lastUpdate: Z(t) };
  (s.settings.themesList.unshift(n), s.saveSettings());
}
function Ct(s, e) {
  return !!s.settings.themesList.find((n) => n.repo === e);
}
function ze(s, e, t) {
  let n = s.settings.pluginSubListFrozenVersion.find((i) => i.repo === e);
...
var j = class {
  ...
  async validateToken(e, t) {
    var n, i, o, a, c, u, g, m, l;
    if (!e)
      return (
        (n = this.statusEl) == null || n.setText("No token provided"),
        (i = this.statusEl) == null || i.addClass("invalid"),
        (o = this.statusEl) == null || o.removeClass("valid"),
        !1
      );
    try {
      let r = await Et(e, t);
      ...
      return (
        ...
        (m = this.statusEl) == null || m.setText("Failed to validate token"),
        (l = this.statusEl) == null || l.addClass("invalid"),
        !1
      );
    }
  }
  showValidTokenInfo(e) {
    ...
    if (
      ...
      let o = new Date(e.expirationDate),
        a = Math.ceil((o.getTime() - Date.now()) / (1e3 * 60 * 60 * 24));
      a < 7 &&
        t.createDiv({ text: `\u26A0\uFE0F Token expires in ${a} days`, cls: "brat-token-warning" });
    }
  }
  showErrorMessage(e) {
    var n, i, o;
    ...
    if (t && (t.createDiv({ text: e.message }), e.details))
      switch (e.type) {
        ...
        case "insufficient_scope":
          t.createDiv({
            text: `Required scopes: ${(o = e.details.requiredScopes) == null ? void 0 : o.join(", ")}`,
          });
          break;
      }
  }
...
function kt({ prependText: s, url: e, text: t, appendText: n }) {
  let i = new DocumentFragment(),
    o = document.createElement("a");
  if (((o.textContent = t), (o.href = e), s)) {
    let a = document.createTextNode(s);
    i.appendChild(a);
  }
  if ((i.appendChild(o), n)) {
...
function E(s, e, t = 10, n) {
  if (!s.settings.notificationsEnabled) return;
  let i = n
      ? Re.Platform.isDesktop
  ...
  ((t.style.float = "right"),
    e
      ...
      : ((t.style.padding = "10px"),
        (t.style.paddingLeft = "15px"),
        (t.style.paddingRight = "15px")));
  let n = t.createDiv("coffee");
  (n.addClass("ex-twitter-span"), (n.style.paddingLeft = "10px"));
  let i = n.createDiv();
  ((i.innerText = "Learn more about my work at:"), n.appendChild(i));
  let o = n.createEl("a", { href: "https://tfthacker.com" });
  return ((o.innerText = "https://tfthacker.com"), t);
};
var St = require("obsidian"),
  Ie = class extends St.SuggestModal {
    ...
    getSuggestions(e) {
      let t = e.toLowerCase();
      return this.versions.filter((n) => n.version.toLowerCase().contains(t));
    }
...
var U = class extends L.Modal {
  constructor(t, n, i = !1, o = !1, a = "", c = "", u = "") {
    super(t.app);
  ...
  async submitForm() {
    ...
    if (this.plugin.settings.pluginSubListFrozenVersion.find((d) => d.repo === t)) {
      ((await this.betaPlugins.addPlugin(
        ...
        (o = this.cancelButton) == null || o.setDisabled(!1),
        (a = this.addPluginButton) == null || a.setDisabled(!1),
        (c = this.addPluginButton) == null || c.setButtonText("Add Plugin"),
        (u = this.versionSetting) == null || u.setDisabled(!1));
      return;
    }
    if (!this.version && Pe(this.plugin, t)) {
      E(this.plugin, "This plugin is already in the list for beta testing", 10);
      return;
    }
    ((await this.betaPlugins.addPlugin(
      t,
      ...
      (g = this.cancelButton) == null || g.setDisabled(!1),
      (m = this.addPluginButton) == null || m.setDisabled(!1),
      (l = this.addPluginButton) == null || l.setButtonText("Add Plugin"),
      (r = this.versionSetting) == null || r.setDisabled(!1));
  }
      ...
      n.length < 20 || L.Platform.isMobile
        ...
        : t.addButton((c) => {
            c.setButtonText(o === "latest" ? "Latest version" : o || "Select a version...")
              ...
              .setClass("button")
              .onClick(() => {
                let g = [{ version: "latest", prerelease: !1 }, ...n];
  ...
  onOpen() {
    ...
    (this.address
      ? (t.appendText("Change plugin version: "), t.appendChild(te(this.address)))
      : t.setText("Github repository for beta plugin:"),
      this.contentEl.createEl("form", {}, (n) => {
        var g;
        (n.addClass("brat-modal"),
          (!this.address || !this.updateVersion) &&
            new L.Setting(n).setClass("repository-setting").then((l) => {
              l.addText((r) => {
                ((this.repositoryAddressEl = r),
                  r.setPlaceholder(
                    "Repository (example: https://github.com/GitHubUserName/repository-name)",
                  ),
                  r.setValue(this.address),
                  r.onChange((d) => {
                    var b, w;
                  ...
                  r.inputEl.addEventListener("keydown", async (d) => {
                    ...
                    d.key === "Enter" &&
                      (this.address &&
                        ...
                        (p = this.versionSetting) == null || p.setDisabled(!0),
                        this.submitForm()),
                      await this.updateRepositoryVersionInfo(this.version, i));
                  }),
                  r.inputEl.addEventListener("blur", async () => {
                    await this.updateRepositoryVersionInfo(this.version, i);
                  }),
                  l.setDesc("Repository"),
                  (r.inputEl.style.width = "100%"));
              });
            }));
        ...
        (this.address || i.setText("Enter a GitHub repository address to validate it."),
          ...
          this.versionSetting.setDisabled(!0));
        let o = n.createDiv("token-setting");
        if (
          (new L.Setting(o)
            .setName("GitHub Token")
            .setDesc("Select a secret as token for this repository (optional)")
            .addComponent((m) =>
              new L.SecretComponent(this.plugin.app, m)
                ...
                .onChange(async (l) => {
                  ...
                  let r = this.secretName
                    ? this.plugin.app.secretStorage.getSecret(this.secretName)
                    : null;
                  r &&
                    ((this.validToken = await ((d = this.validator) == null
                      ? void 0
          ...
          let m = this.plugin.app.secretStorage.getSecret(this.secretName);
          m &&
            ((g = this.validator) == null ||
              g.validateToken(m, this.address).then((l) => {
                var r, d;
                ((this.validToken = l),
                  this.validToken &&
        ...
        n.createDiv("modal-button-container", (m) => {
          var l;
          (m.createEl("label", { cls: "mod-checkbox" }, (r) => {
            let d = r.createEl("input", { attr: { tabindex: -1 }, type: "checkbox" });
            ((d.checked = this.enableAfterInstall),
              d.addEventListener("click", () => {
                this.enableAfterInstall = d.checked;
              }),
              r.appendText("Enable after installing the plugin"));
          }),
            (this.cancelButton = new L.ButtonComponent(m)
        ...
        let a = n.createDiv();
        ((a.style.borderTop = "1px solid #ccc"), (a.style.marginTop = "30px"));
        let c = a.createSpan();
        (c.createEl("a", { href: "https://bit.ly/o42-twitter", text: "TFTHacker" }),
          c.appendText(" and "),
          c.createEl("a", { href: "https://github.com/johannrichard", text: "johannrichard" }),
          (c.style.fontStyle = "italic"),
          a.appendChild(c),
          z(a, !1));
        let u = n.querySelectorAll("button");
        for (let m of Array.from(u)) m.setAttribute("type", "button");
        n.addEventListener("submit", (m) => {
  ...
  async updateRepositoryVersionInfo(t = "", n) {
    var a, c, u, g, m, l;
    let i = this.repositoryAddressEl;
    if (
      (this.plugin.settings.debuggingMode &&
        console.log(
          `[BRAT] Updating version dropdown for ${this.address} with selected version ${t}`,
        ),
      !this.address)
    ) {
      (n == null || n.setText("Repository address is required."),
        n == null || n.addClass("validation-status-error"));
      return;
    }
    (n == null || n.setText("Validating repository address..."),
      n == null || n.removeClass("validation-status-error"),
      this.versionSetting &&
        this.updateVersion &&
        this.updateVersionDropdown(this.versionSetting, []));
    let o = ye(this.address);
    try {
      let r = "";
      if (this.secretName) {
      ...
      let d = await yt(o, this.plugin.settings.debuggingMode, r);
      d && d.length > 0
      ...
      if (
        (r instanceof D &&
          ...
          n == null ||
            n.setText(
              `GitHub API rate limit exceeded. Try again in ${r.getMinutesToReset()} minutes.`,
            ),
          this.versionSetting &&
            (this.versionSetting.settingEl.classList.add("disabled-setting"),
            this.versionSetting.setDisabled(!0),
            (g = this.addPluginButton) == null || g.setDisabled(!0)),
          E(
            this.plugin,
            `${r.message} Consider adding a personal access token in BRAT settings for higher limits. See documentation for details.`,
            20,
            () => {
              window.open(
        ...
        (n == null || n.addClass("validation-status-error"),
          (m = this.versionSetting) == null || m.setDisabled(!0),
          (l = this.addPluginButton) == null || l.setDisabled(!0),
          E(this.plugin, `${d.message} `, 20));
      }
    }
  }
  onClose() {
...
async function Ne() {
  try {
    let s = await (0, Dt.requestUrl)(`https://obsidian.md/?${Math.random()}`);
...
var $t = Ue(),
  ...
  ne = class {
    ...
    displayAddNewPluginModal(e = !1, t = !1, n = "", i = "", o = "") {
      new U(this.plugin, this, e, t, n, i, o).open();
    }
    async validateRepository(e, t = !1, n = !1, i = "", o = "") {
      let c = o;
      try {
        let u = await He(e, this.plugin.settings.debuggingMode, c),
          g = await Ge(e, i, t, this.plugin.settings.debuggingMode, u, c);
        if (!g)
          return (
            n &&
              (E(
...
This does not seem to be an obsidian plugin with valid releases, as there are no releases available.`,
        ...
        let m = await Q(g, "manifest.json", this.plugin.settings.debuggingMode, u, c);
        if (!m)
          return (
            n &&
              (E(
...
The version attribute for the release is missing from the manifest file`,
        ...
        try {
          let r = Ae(g.tag_name, { includePrerelease: !0, loose: !0 }),
            d = Ae(l.version, { includePrerelease: !0, loose: !0 });
          $t(r, d) !== 0 &&
            (n &&
              E(
                this.plugin,
...
The release tag version will be used to ensure consistency.`,
        ...
        if (u instanceof D) {
          let g = `GitHub API rate limit exceeded. Reset in ${u.getMinutesToReset()} minutes.`;
          throw (
            n && E(this.plugin, g, 15),
            console.error(`BRAT: validateRepository ${u}`),
            E(
              this.plugin,
              `${u.message} Consider adding a personal access token in BRAT settings for higher limits. See documentation for details.`,
              20,
              () => {
                window.open(
                  "https://github.com/TfTHacker/obsidian42-brat/blob/main/BRAT-DEVELOPER-GUIDE.md#github-api-rate-limits",
...
GitHub API Authentication error. Please verify that your personal access token is valid and set correctly.`,
                ...
                : E(
                    this.plugin,
                    `${e}
GitHub API error ${u.status}: ${u.message}`,
                    15,
                  )),
            console.error(`BRAT: validateRepository ${u}`),
            u
        ...
        return (
          n &&
            E(
              this.plugin,
              `${e}
Unspecified error encountered: ${u}, verify debug for more information.`,
              15,
            ),
          null
        );
    ...
    async getAllReleaseFiles(e, t, n = "", i = "") {
      let o = i,
        a = await He(e, this.plugin.settings.debuggingMode, o),
        c = await Ge(e, n, t, this.plugin.settings.debuggingMode, a, o);
      if (!c) return Promise.reject("No release found");
      let u = t || n !== "";
      return (
        console.log({ reallyGetManifestOrNot: u, version: c.tag_name }),
        {
          mainJs: await Q(c, "main.js", this.plugin.settings.debuggingMode, a, o),
          manifest: u ? await Q(c, "manifest.json", this.plugin.settings.debuggingMode, a, o) : "",
          styles: await Q(c, "styles.css", this.plugin.settings.debuggingMode, a, o),
        }
      );
    }
    async writeReleaseFilesToPluginFolder(e, t) {
      var o, a;
      let n = `${(0, k.normalizePath)(`${this.plugin.app.vault.configDir}/plugins/${e}`)}/`,
        { adapter: i } = this.plugin.app.vault;
      ((await i.exists(n)) || (await i.mkdir(n)),
        await i.write(`${n}main.js`, (o = t.mainJs) != null ? o : ""),
        await i.write(`${n}manifest.json`, (a = t.manifest) != null ? a : ""),
        t.styles && (await i.write(`${n}styles.css`, t.styles)));
    }
    async addPlugin(
      e,
      t = !1,
      ...
      o = "",
      a = !1,
      c = this.plugin.settings.enableAfterInstall,
      u = "",
    ) {
      try {
        this.plugin.settings.debuggingMode &&
        ...
        u && u.trim() !== ""
          ? ((g = (await this.plugin.app.secretStorage.getSecret(u)) || ""),
            g ||
              E(
                this.plugin,
                `Secret not found for token name: ${u}. Please add it to SecretStorage or clear the token name for this plugin.`,
                10,
              ))
...
You will need to update your Obsidian to use this plugin or contact the plugin developer for more information.`;
            return (await this.plugin.log(p, !0), E(this.plugin, p, 30), !1);
          }
          if (
            !(await De({
              app: this.plugin.app,
              message: createFragment((p) => {
                (p.appendText("Plugin: "),
                  ...
                  p.createEl("code", { text: l.minAppVersion }),
                  p.appendText(", but this installation of Obsidian is "),
                  p.createEl("code", { text: k.apiVersion }),
                  p.appendText("."),
                  p.createEl("br"),
                  p.appendText(
                  ...
                  p.createEl("br"),
                  p.appendText("Do you want to install it anyways?"));
              }),
            }))
          )
            return !1;
        ...
        let b = async () => {
          ...
          if (
            (d &&
              ((p.brat = { isIncompatible: !0, minAppVersionOriginal: p.minAppVersion }),
              (p.minAppVersion = k.apiVersion)),
            k.Platform.isMobile && p.isDesktopOnly)
          )
            if (this.plugin.settings.allowIncompatiblePlugins) {
              if (
                !(await De({
                  app: this.plugin.app,
                  message: createFragment((R) => {
                    (R.appendText("Plugin: "),
                      R.createEl("code", { text: e }),
                      R.createEl("br"),
                      R.appendText("The "),
                ...
                return null;
              ((p.isDesktopOnly = !1),
                (C = p.brat) != null || (p.brat = {}),
                (p.brat.isDesktopOnlyOriginal = !0),
                (p.brat.isIncompatible = !0),
                (d = !0));
            } else {
              let N = `Plugin: ${e}
...
The release is not complete and cannot be downloaded. main.js is missing from the Release`;
            return (await this.plugin.log(N, !0), E(this.plugin, N, m), null);
          }
          return w;
        };
        if (!t || a) {
          ...
          if (w === null) return !1;
          if (
            (await this.writeReleaseFilesToPluginFolder(l.id, w), Nt(this.plugin, e, o, d, u), c)
          ) {
            let { plugins: p } = this.plugin.app,
              T = (0, k.normalizePath)(`${p.getPluginFolder()}/${l.id}`);
            (await p.loadManifest(T), await p.enablePluginAndSave(l.id));
          }
          if ((await this.plugin.app.plugins.loadManifests(), a))
            (await this.reloadPlugin(l.id),
              await this.plugin.log(`${e} reinstalled`, !0),
              E(
                this.plugin,
                `${e}
Plugin has been reinstalled and reloaded with version ${l.version}`,
                m,
              ));
          else {
            let p = o === "" ? "" : ` (version: ${o})`,
...
The plugin has been registered with BRAT.`;
          ...
          let w = `${this.plugin.app.vault.configDir}/plugins/${l.id}/`,
            p = "";
          try {
            p = await this.plugin.app.vault.adapter.read(`${w}manifest.json`);
          } catch (R) {
          ...
          if ($t(C, N) === -1) {
            ...
            if (R === null) return !1;
            if (n) {
              let J = `There is an update available for ${l.id} from version ${T.version} to ${l.version}. `;
              return (
                await this.plugin.log(
                  `${J}[Release Info](https://github.com/${e}/releases/tag/${l.version})`,
                  !0,
                ),
                E(this.plugin, J, 30, () => {
            ...
            (await this.writeReleaseFilesToPluginFolder(l.id, R),
              await this.plugin.app.plugins.loadManifests(),
              await this.reloadPlugin(l.id));
            let P = `${l.id}
Plugin has been updated from version ${T.version} to ${l.version}. `;
            return (
              await this.plugin.log(
                `${P}[Release Info](https://github.com/${e}/releases/tag/${l.version})`,
                !0,
              ),
              E(this.plugin, P, 30, () => {
                l && window.open(`https://github.com/${e}/releases/tag/${l.version}`);
          ...
          return (i && E(this.plugin, `No update available for ${e}`, 3), !0);
        }
      } catch (g) {
    ...
    async reloadPlugin(e) {
      ...
      try {
        ...
        this.plugin.settings.debuggingMode && console.log("reload plugin", n);
      }
    }
    async updatePlugin(e, t = !1, n = !1, i = !1, o = "") {
      let a = await this.addPlugin(e, !0, t, n, "", i, !1, o);
      return (
        !a &&
          !t &&
          E(
...
${i}`,
    ...
    getEnabledDisabledPlugins(e) {
      let t = this.plugin.app.plugins,
        n = Object.values(t.manifests),
        i = Object.values(t.plugins).map((o) => o.manifest);
      return e
        ? n.filter((o) => i.find((a) => o.id === a.id))
        : n.filter((o) => !i.find((a) => o.id === a.id));
    }
    checkIncompatiblePlugins() {
      let e = this.plugin.settings.pluginSubListFrozenVersion
        .filter((t) => t.isIncompatible)
        .map((t) => t.repo);
      e.length > 0 &&
        E(
          this.plugin,
...
var se = async (s, e, t) => {
    let n = await G(e, !0, s.settings.debuggingMode);
    if ((n || (n = await G(e, !1, s.settings.debuggingMode)), !n))
      return (
        E(
          s,
    ...
    let i = await Rt(e, s.settings.debuggingMode);
    if (!i)
      return (
        E(
          s,
    ...
    let o = await JSON.parse(i),
      a = (0, _.normalizePath)(Un(s) + o.name),
      { adapter: c } = s.app.vault;
    ((await c.exists(a)) || (await c.mkdir(a)),
      await c.write((0, _.normalizePath)(`${a}/theme.css`), n),
      await c.write((0, _.normalizePath)(`${a}/manifest.json`), i),
      Lt(s, e, Z(n)));
    let u = "";
    return (
      t
        ? (At(s, e, n),
          (u = `${o.name} theme installed from ${e}. `),
          setTimeout(() => {
            s.app.customCss.setTheme(o.name);
          }, 500))
        : (u = `${o.name} theme updated from ${e}.`),
      s.log(`${u}[Theme Info](https://github.com/${e})`, !1),
      E(s, u, 20, () => {
  ...
  q = async (s, e) => {
    ...
    let t,
      n = "Checking for beta theme updates STARTED";
    (await s.log(n, !0),
      e &&
...
${n}`,
    ...
    for (let o of s.settings.themesList) {
      let a = await ee(o.repo, !0, s.settings.debuggingMode);
      (a === "0" && (a = await ee(o.repo, !1, s.settings.debuggingMode)),
        console.log("BRAT: lastUpdateOnline", a),
        a !== o.lastUpdate && (await se(s, o.repo, !1)));
    }
  ...
  Un = (s) => `${(0, _.normalizePath)(`${s.app.vault.configDir}/themes`)}/`;
var xt = "brat-migrations";
async function _n(s, e) {
  try {
    let t = await s.vault.adapter.read(`${s.vault.configDir}/plugins/obsidian42-brat/${xt}.json`);
...
async function Hn(s, e) {
  try {
    let t = `${s.vault.configDir}/plugins/obsidian42-brat/${xt}.json`,
      n = { appliedMigrations: [] };
    try {
      let i = await s.vault.adapter.read(t);
      n = JSON.parse(i);
    } catch (i) {}
...
async function Ot(s, e, t) {
  let n = "tokens-to-secretstorage-v1";
  if (!(await _n(s, n)))
    try {
      let i = 0,
        o = (u) => {
          let m = `brat-gh-${u
            ...
            .replace(/-+/g, "-")
            .replace(/^-|-$/g, "")}`;
          return m.length > 64 ? m.substring(0, 64).replace(/-$/, "") : m;
        },
        a = (u) => {
          let g = s.secretStorage.listSecrets();
          for (let m of g) if (s.secretStorage.getSecret(m) === u) return m;
          return null;
        },
        c = (u, g) => {
          let m = a(u);
      ...
      if (e.personalAccessToken && e.personalAccessToken.trim() !== "") {
        let u = e.personalAccessToken.trim(),
          m = c(u, "brat-gh-global");
        ((e.globalTokenName = m), (e.personalAccessToken = ""), i++);
      }
      if (e.pluginSubListFrozenVersion) {
        for (let u of e.pluginSubListFrozenVersion)
          if (u.token && u.token.trim() !== "") {
            let g = u.token.trim(),
              m = o(u.repo),
              l = c(g, m);
...
var B = class extends H.Modal {
  ...
  async submitForm() {
    ...
    if (Ct(this.plugin, e)) {
      E(this.plugin, "This theme is already in the list for beta testing", 10);
      return;
    }
    (await se(this.plugin, e, !0)) && this.close();
  }
  onOpen() {
    (this.contentEl.createEl("h4", { text: "Github repository for beta theme:" }),
      this.contentEl.createEl("form", {}, (e) => {
        (e.addClass("brat-modal"),
          new H.Setting(e).addText((i) => {
            (i.setPlaceholder(
              "Repository (example: https://github.com/GitHubUserName/repository-name",
            ),
        ...
        let n = t.createSpan();
        (n.createEl("a", { href: "https://bit.ly/o42-twitter", text: "TFTHacker" }),
          n.appendText(" and "),
          n.createEl("a", { href: "https://github.com/johannrichard", text: "johannrichard" }),
...
var Mt = require("obsidian"),
  S = class extends Mt.FuzzySuggestModal {
    constructor(t) {
      super(t.app);
      this.data = [];
      (this.scope.register(["Shift"], "Enter", (n) => {
        this.enterTrigger(n);
      }),
        this.scope.register(["Ctrl"], "Enter", (n) => {
          this.enterTrigger(n);
        }));
    }
    setSuggesterData(t) {
    ...
    renderSuggestion(t, n) {
      n.createEl("div", { text: t.item.display });
    }
    enterTrigger(t) {
      var o;
      let n =
    ...
    onChooseSuggestion(t, n) {
      this.invokeCallback(t.item, n);
    }
    invokeCallback(t, n) {
      typeof this.callbackFunction == "function" && this.callbackFunction(t, n);
    }
  };
var ie = class {
  constructor(e) {
        ...
        callback: () => {
          let e = new Map(
            ...
            t = Object.values(this.plugin.settings.pluginList)
              .filter((i) => {
                let o = e.get(i);
                return !(o != null && o.version) || o.version === "latest";
              })
...
${o}`,
                ...
                this.plugin.betaPlugins.updatePlugin(
                  i.info,
                  !1,
                  !0,
                  !1,
...
${o}`,
      ...
      },
      {
        ...
        showInRibbon: !0,
        callback: () => {
          let e = Object.values(this.plugin.app.plugins.manifests).map((n) => ({
              display: n.id,
              info: n.id,
            })),
            t = new S(this.plugin);
...
Plugin reloading .....`,
                ...
                this.plugin.betaPlugins.reloadPlugin(n.info));
            }));
        },
      },
      {
        ...
        callback: () => {
          let e = this.plugin.betaPlugins
              ...
              .map((n) => ({ display: `${n.name} (${n.id})`, info: n.id })),
            t = new S(this.plugin);
          (t.setSuggesterData(e),
            t.display((n) => {
              (this.plugin.log(`${n.display} plugin disabled`, !1),
                this.plugin.settings.debuggingMode && console.log(n.info),
                this.plugin.app.plugins.disablePluginAndSave(n.info));
            }));
        },
      },
      {
        ...
        callback: () => {
          ...
          (t.setSuggesterData(e),
            t.display((n) => {
              (this.plugin.log(`${n.display} plugin enabled`, !1),
                this.plugin.app.plugins.enablePluginAndSave(n.info));
            }));
        },
      },
      {
        ...
        showInRibbon: !0,
        callback: async () => {
          let e = await vt(this.plugin.settings.debuggingMode);
          if (e) {
            let t = Object.values(e).map((o) => ({
                display: `Plugin: ${o.name}  (${o.repo})`,
                info: o.repo,
              })),
              n = Object.values(this.plugin.settings.pluginList).map((o) => ({
                display: `BRAT: ${o}`,
                info: o,
              }));
            for (let o of t) n.push(o);
            let i = new S(this.plugin);
            (i.setSuggesterData(n),
              i.display((o) => {
      ...
      },
      {
        ...
        showInRibbon: !0,
        callback: async () => {
          let e = await Pt(this.plugin.settings.debuggingMode);
          if (e) {
      ...
      },
      {
        ...
        callback: () => {
          let e = this.plugin.app.setting,
            t = Object.values(e.pluginTabs).map((o) => ({
              display: `Plugin: ${o.name}`,
              info: o.id,
            })),
            n = new S(this.plugin),
            i = Object.values(e.settingTabs).map((o) => ({
              display: `Core: ${o.name}`,
              info: o.id,
            }));
          for (let o of t) i.push(o);
          (n.setSuggesterData(i),
            n.display((o) => {
              (e.open(), e.openTabById(o.info));
            }));
        },
      },
      {
  ...
  ribbonDisplayCommands() {
    ...
    for (let a of this.bratCommands)
      a.showInRibbon && e.push({ display: a.name, info: a.callback });
    let t = new S(this.plugin),
      n = this.plugin.app.setting,
      i = Object.values(n.settingTabs).map((a) => ({
        display: `Core: ${a.name}`,
        info: () => {
          (n.open(), n.openTabById(a.id));
        },
      })),
      o = Object.values(n.pluginTabs).map((a) => ({
...
var Le = class extends A.PluginSettingTab {
  constructor(t, n) {
    super(t, n);
  ...
  display() {
    ...
    (o.addSearch((l) => {
      (l.setPlaceholder("Filter plugins"),
        l.onChange((r) => {
          let d = r.toLowerCase().trim();
          i.forEach(({ container: b, pluginName: w }) => {
            d === "" || w.includes(d)
    ...
    for (let l of this.plugin.settings.pluginList) {
      let r = n.get(l);
      o.addSetting((d) => {
        let b = (r == null ? void 0 : r.tokenName) || "",
          w = b ? this.plugin.app.secretStorage.getSecret(b) : "",
          p = !!(b && !w),
          T = document.createDocumentFragment(),
          C =
            r != null && r.version
              ? ` Tracked version: ${r.version} ${r.version === "latest" ? "" : "(frozen)"}`
              : "",
          N = r != null && r.isIncompatible ? " (incompatible)" : "";
        (T.createDiv({ text: `${C}${N}` }),
          p &&
            T.createDiv({
              text: ` Secret not defined or empty: ${b}`,
              cls: "mod-warning",
              title:
                "Token name configured but secret is missing. Add the secret or update the plugin configuration.",
            }),
          d.setName(te(l)).setDesc(T));
        let R = d.settingEl;
        (R.addClass("brat-plugin-item"),
          i.set(l, { container: R, pluginName: l.toLowerCase() }),
          (!(r != null && r.version) || r.version === "latest") &&
            d.addButton((P) => {
              p
                ? P.setIcon("sync")
                    .setTooltip(
                      `Secret missing: ${b}. Please add the secret or update the plugin configuration.`,
                    )
                    .setWarning()
                    .setDisabled(!0)
                : P.setIcon("sync")
          ...
          d
            ...
            .addButton((P) => {
              P.setIcon("cross")
                ...
                .setWarning()
                .onClick(() => {
                  if (P.buttonEl.textContent === "")
                    P.setButtonText("Click once more to confirm removal");
                  else {
                    let { buttonEl: J } = P,
                      { parentElement: M } = J;
                    M != null &&
    ...
    let a = new Map(),
      c = new A.SettingGroup(t).setHeading("Beta themes list");
    (c.addSetting((l) =>
      l.addButton((r) => {
        r.setButtonText("Add beta theme")
          .setCta()
          .onClick(() => {
            (this.plugin.app.setting.close(), new B(this.plugin).open());
          });
      }),
    ),
      c.addSearch((l) => {
        (l.setPlaceholder("Filter themes"),
          l.onChange((r) => {
            let d = r.toLowerCase().trim();
            a.forEach(({ container: b, themeName: w }) => {
              d === "" || w.includes(d)
                ? b.removeAttribute("hidden")
                : b.setAttribute("hidden", "true");
            });
    ...
    for (let l of this.plugin.settings.themesList)
      c.addSetting((r) => {
        r.setName(te(l.repo));
        let d = r.settingEl;
        (d.addClass("brat-theme-item"),
          a.set(l.repo, { container: d, themeName: l.repo.toLowerCase() }),
          r.addButton((b) => {
            b.setIcon("cross")
              .setTooltip("Delete this beta theme")
              .onClick(() => {
                if (b.buttonEl.textContent === "")
                  b.setButtonText("Click once more to confirm removal");
                else {
                  let { buttonEl: w } = b,
                    { parentElement: p } = w;
                  p != null &&
                    p.parentElement &&
                    (p.parentElement.remove(), Ce(this.plugin, l.repo));
                }
              });
          }));
      });
    new A.SettingGroup(t)
    ...
    g.addSetting((l) => {
      (l.setName("Personal access token").setDesc(
        ...
        this.accessTokenSetting
          ...
          .onChange(async (r) => {
            var b, w, p;
            let d = (r == null ? void 0 : r.trim()) || "";
            ((this.plugin.settings.globalTokenName = d),
              await this.plugin.saveSettings(),
              d
                ? ((m = this.plugin.app.secretStorage.getSecret(d) || ""),
        ...
        l
          ...
          .then(() => {
            ...
            ((this.tokenInfo = this.createTokenInfoElement(t)),
              (this.validator = new j(this.tokenInfo)),
              (r = this.validator) == null ||
                r.validateToken(m).then((d) => {
                  var b;
                  (b = this.accessTokenButton) == null ||
                    b.setDisabled(d || !this.plugin.settings.globalTokenName);
                }));
          }));
    });
  }
  ...
  constructor(e) {
    ...
    this.themes = {
      ...
      themeInstallTheme: async (e) => {
        ...
        await se(this.plugin, t, !0);
      },
      themesDelete: (e) => {
        let t = e.replace("https://github.com/", "");
        Ce(this.plugin, t);
      },
      grabCommmunityThemeCssFile: async (e, t = !1) =>
        await G(e, t, this.plugin.settings.debuggingMode),
      grabChecksumOfThemeCssFile: async (e, t = !1) =>
        await ee(e, t, this.plugin.settings.debuggingMode),
      grabLastCommitDateForFile: async (e, t) => await It(e, t),
    };
    this.plugin = e;
  }
};
...
async function en(s, e, t = !1) {
  if ((s.settings.debuggingMode && console.log(`BRAT: ${e}`), s.settings.loggingEnabled)) {
    ...
    let n = `${s.settings.loggingPath}.md`,
      i = `[[${(0, W.moment)()
        .format((0, Zt.getDailyNoteSettings)().format)
        .toString()}]] ${(0, W.moment)().format("HH:mm")}`,
      o = W.Platform.isDesktop ? window.require("os") : null,
      a = W.Platform.isDesktop ? (o == null ? void 0 : o.hostname()) : "MOBILE",
      c = `${i} ${a} ${e.replace(
        `
`,
        " ",
...
`,
      u = s.app.vault.getAbstractFileByPath(n);
    u ? await s.app.vault.append(u, c) : (u = await s.app.vault.create(n, c));
  }
}
var ke = class extends tn.Plugin {
  constructor() {
    super(...arguments);
    this.APP_NAME = "BRAT";
    this.APP_ID = "obsidian42-brat";
    this.settings = je;
    this.betaPlugins = new ne(this);
    this.commands = new ie(this);
    this.bratApi = new oe(this);
    this.obsidianProtocolHandler = (t) => {
      if (!t.plugin && !t.theme) {
        E(this, "Could not locate the repository from the URL.", 10);
        return;
      }
      for (let n of ["plugin", "theme"])
        if (t[n]) {
          let i;
          switch (n) {
            case "plugin":
              ...
              break;
            case "theme":
              ((i = new B(this)), (i.address = t[n]), i.open());
              break;
          }
          return;
        }
  ...
  onload() {
    (console.log(`loading ${this.APP_NAME}`),
      ...
      this.loadSettings()
        .then(async () => {
          (await Ot(this.app, this.settings, () => this.saveSettings()),

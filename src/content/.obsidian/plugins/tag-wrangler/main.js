  ...
  cr = (s, e, t, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of or(e))
        !ar.call(s, i) &&
          i !== t &&
          Bt(s, i, { get: () => e[i], enumerable: !(n = rr(e, i)) || n.enumerable });
    return s;
  };
...
function Jt(s, e, t) {
  ...
  return (
    n
      ? ((Kt = n.n), (n.n = e || n), (n.p = t || n))
      : ((n = new qs()), e && (n.n = e), t && (n.p = t)),
    (n.v = s),
    (n.n.p = n),
    (n.p.n = n),
    n
  ...
  _e = class {
    constructor() {
      ((this.end = () => {
        ...
        ie.delete(null);
        for (let r of ie)
          (r._cbs && (r._cbs = Mn(r._done, r._cbs)),
            ie.delete(r),
            js(r._done) && r.throw(xe(r._done)));
        P(i);
      }),
        (this._done = void 0),
        (this._cbs = void 0));
...
var re = class {
  ...
  setValue(e, t) {
    (this.shouldWrite(e !== this.value || t !== !!(this.flags & 16)) &&
      ((this.value = e),
      (this.lastChanged = D),
      (this.flags = t ? this.flags | 16 : this.flags & -17)),
  ...
  stop() {
    var e;
    (this.setQ(null),
      this.flags & 32 ? (this.flags |= 2) : this.updateDemand(),
      (e = Yn.get(this)) == null || e());
  }
  setQ(e = Hs) {
    e != this.queue &&
  ...
  subscribe(e) {
    (!this.subscribers && !this.queue && Zn(this),
      this.subscribers !== e &&
        !e.pT &&
        ((e.nT = this.subscribers),
        this.subscribers && (this.subscribers.pT = e),
        (this.subscribers = e)));
  }
  unsubscribe(e) {
    (e.nT && (e.nT.pT = e.pT),
...
function Pr(s, e, t) {
  ...
  function l() {
    (s[e] === a && (i ? (s[e] = r) : delete s[e]),
      o !== r && ((o = r), Object.setPrototypeOf(a, n || Function)));
  }
}
var Mr = ((s) =>
    ...
    (s.plugin = function (e) {
      if (!$e)
        (Dr(e),
          ($e = s.fork()),
          $e.set(Be.Plugin, e),
          $e.set(e.constructor, e),
          e.addChild($e.use(li)));
      else if (e !== $e.use(Be.Plugin))
  ...
  _ = class {
    ...
    tagString(e) {
      for (let [t, n] of Object.entries(this.tags))
        if (e.startsWith(n)) return t + Vr(e.substring(n.length));
      return e[0] === "!" ? e : `!<${e}>`;
    }
    toString(e) {
...
var me = class extends ke {
  ...
  toJSON(e, t) {
    ...
    if (
      r >= 0 &&
      ((a.count += 1),
      a.aliasCount === 0 && (a.aliasCount = ns(i, o, n)),
...
function ge(s, e, t) {
  ...
  if (O(s)) {
    let d =
      (i = (n = t.schema[Q]).createNode) === null || i === void 0
        ? void 0
        : i.call(n, t.schema, null, t);
...
function Xr(
  ...
  for (let g = 0; g < e.length; ++g) {
    let p = e[g],
      m = null;
    if (C(p))
      (!f && p.spaceBefore && h.push(""),
        fs(t, h, p.commentBefore, f),
...
` + d.comment)
    ...
    (t.schema.compat && Nt(n.indent, u, i),
      Cs(t, o.items, m) && i(p, "DUPLICATE_KEY", "Map keys must be unique"));
    let y = le(f || [], {
    ...
    if (!w.found) {
      if (!w.anchor && !w.tag && !b && !k) {
        (g === 0 && w.comma
          ...
          : g < n.items.length - 1 &&
            i(w.start, "UNEXPECTED_TOKEN", `Unexpected empty item in ${o}`),
          w.comment &&
            (a.comment
              ? (a.comment +=
                  `
...
`.repeat(Math.max(0, o.length - 1))
      ...
      m = n + i.length;
    return (
      s.source && (m += s.source.length),
      { value: p, type: r, comment: i.comment, range: [n, m, m] }
    );
  }
...
function lo(s, e) {
  return (
    (s[s.length - 1] !== "'" || s.length === 1) &&
      e(s.length, "MISSING_CHAR", "Missing closing 'quote"),
...
var $t = class {
  ...
  *next(e) {
    ...
    if (t)
      ...
      (yield* this.pop({ type: "error", offset: this.offset, message: n, source: e }),
        (this.offset += e.length));
    }
  }
  *end() {
...
`),
  ...
  onload() {
    (this.registerEvent(
      ...
      this.register(
        ve(document, "contextmenu", ".tag-pane-tag", this.onMenu.bind(this), { capture: !0 }),
      ),
    ...
    (this.register(
      ve(document.body, "dragover", ".tag-pane-tag.tree-item-self", t, { capture: !0 }),
    ),
      this.register(
        ve(document.body, "dragenter", ".tag-pane-tag.tree-item-self", t, { capture: !0 }),
      ),
  ...
  setupMenu(t, n, i = !1) {
    ...
    (t.addItem(be("tag-rename", "pencil", "Rename #" + n, () => this.rename(n))),
      ...
      a &&
        (t.addItem(
          be("tag-search", "magnifying-glass", "New search for #" + n, () =>
            a.openGlobalSearch("tag:#" + n),
          ),
        ),
        l &&
          t.addItem(

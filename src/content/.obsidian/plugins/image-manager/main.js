      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            visible: () =>
              this.plugin.settings.banner[currentDevice].enabled &&
...
var BannerService = class {
  ...
  getDeviceSettings() {
    ...
    return (_a = this.settings.banner[device]) != null
      ? _a
    ...
    if (file.extension === "md") {
      ...
      if ((cache == null ? void 0 : cache.frontmatter) != null) {
        ...
        const hasIconProperty =
          deviceSettings.iconEnabled && getNestedProperty(cache.frontmatter, iconProp2) != null;

...
function readCMSSettings(config, pluginSettings) {
  ...
  return {
    ...
    propertyLayout910SideBySide:
      (_n = getConfig("propertyLayout910SideBySide")) != null ? _n : false,
    propertyLayout1112SideBySide:
      (_o = getConfig("propertyLayout1112SideBySide")) != null ? _o : false,
    propertyLayout1314SideBySide:
      (_p = getConfig("propertyLayout1314SideBySide")) != null ? _p : false,
    ...
    draftStatusUseFilenamePrefix:
      (_t = getConfig("draftStatusUseFilenamePrefix")) != null ? _t : false,
...
function getCMSViewOptions() {
  return [
    ...
    },
    {
      type: "group",
      displayName: "Title",
      items: [...getPropItems("Title property", "titleProperty")],
    },
    {
      type: "group",
      ...
      items: [
        ...
        {
          type: "toggle",
          displayName: "Render preview as Markdown",
          key: "richContentPreview",
          default: false,
        },
        {
          type: "toggle",
          displayName: "Scroll Markdown preview when it overflows",
          key: "richContentPreviewScroll",
          default: false,
          showWhen: { key: "richContentPreview", value: true },
        },
        {
          type: "toggle",
      ...
      items: [
        {
          ...
          key: "imageFormat",
          options: { none: "No image", thumbnail: "Thumbnail", cover: "Cover" },
          default: "thumbnail",
        },
        ...
        },
        {
          ...
          step: 0.05,
          default: 0.55,
          showWhen: { key: "imageFormat", value: "cover" },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        ...getPropItems("Tags property", "tagsProperty"),
        {
          ...
          step: 1,
          default: 3,
          showWhen: { key: "showTags", value: true },
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          key: "propertyLabels",
          options: { hide: "Hide", inline: "Inline", above: "On top" },
          default: "hide",
        },
        {
          type: "slider",
        ...
        items: [
          {
            ...
            control: {
              type: "slider",
              key: "embeddedViewRefreshDebounceMs",
              min: 50,
              max: 500,
              step: 25,
            },
        ...
        items: [
          {
            ...
            render: (setting) => {
              setting.addToggle((toggle) =>
                toggle.setValue(this.plugin.settings.enableQuickEdit).onChange(async (value) => {
  ...
  display() {
    ...
    appearanceGroup.addSetting((setting) => {
      setting
        ...
        .setDesc(
          "Use the home icon instead of blocks icon for the plugin view in the view selector. Restart Obsidian for this change to take effect.",
        )
        .addToggle((toggle) => {
  ...
  for (const prop of properties) {
    ...
    if (!propertyExists && app) {
      ...
      if (
        ...
        (file.extension === "mdx" || file.extension === "md")
      ) {
        const frontmatter = await getFileFrontmatter(app, file);
        if (frontmatter) {
...
function getListSeparator() {
  let value = getComputedStyle(activeDocument.body).getPropertyValue("--bases-cms-list-separator");
  if (
...
function setupNewNoteInterceptor(app, containerEl, config, pluginSettings, registerCleanup) {
  ...
  const observer = new MutationObserver(() => {
    const buttons2 = activeDocument.querySelectorAll(
  ...
  const buttons = activeDocument.querySelectorAll(
    '.bases-toolbar-new-item-menu, .bases-toolbar-new-item-menu .text-icon-button, [data-action="new-item"]',
  );
...
function getSecondaryFromEntry(entry, propertyKey) {
  ...
  if (value.data != null) {
    ...
    if (d instanceof Date)
      return d.toLocaleDateString(void 0, { year: "numeric", month: "numeric", day: "numeric" });
...
function registerBasesCMSView(plugin, retries = 5) {
  try {
    ...
    if (typeof basesPlugin.registerBasesView === "function") {
      ...
      if (basesPlugin.registerBasesView)
      ...
      if (nextSettingItem && nextSettingItem.classList.contains("input-row")) {
        ...
        if (nextNameEl && nextNameEl.textContent === "Nested path (after the dot)") {
          ...
          const updateVisibility = () => {
            ...
            const isChecked = container2
              ? container2.classList.contains("is-enabled")
              : checkbox.checked;
